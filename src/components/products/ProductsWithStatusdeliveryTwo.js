...
const ProductsWithStatusdeliveryTwo = (props) => {
    ...
    const handleSearch = debounce(async (event) => {
        ...
        if (data) {
            ...
            if (res && +res.EC === 0) {
                let data = res.DT
                let results = data.filter(item => item.statusdelivery_id === 2)
    ...
    const dataWithSortTime = async () => {
        ...
        if (StartDateCalendar && endDateCalendar) {
            ...
            if (res && +res.EC === 0) {
                ...
                let results = resultsSearch.filter(item => item.statusdelivery_id === 2)
                                                                                ...
                                                                                return (
                                                                                    <>    <tr key={`row-${index}`}>
                                                                                        ...
                                                                                        {item?.statusdelivery_id === 2 &&
                                                                                            <td style={{ color: "gray", fontWeight: "700" }} >{item?.Statuspayment?.status ?
